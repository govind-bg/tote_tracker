...
MAP_NAME = "Images/huron_lan_map.png"
RAW_FILE_NAME = "raw_data/raw_file_lan.csv"
# Manually sourced coordinates of the systems

# WRONG WRONG WRONG for LANSING, THESE HAVE NOT BEEN UPDATED
system_coordinates = {
    ...
    "Divert_NorthToteLoop_Discharge": (219, 283),
    "Divert_NorthToteLoop_Recirc": (335, 250),
    "Divert_NorthToSouth_Interchange": (475, 250)
}
...
box_position_coordinates = {
    ...
    "Divert_NorthToteLoop_Discharge": [-80, -20, -40, 20],
    "Divert_NorthToteLoop_Recirc": [-80, -20, -40, 20],
    "Divert_NorthToSouth_Interchange": [40, -20, 80, 20]
}
